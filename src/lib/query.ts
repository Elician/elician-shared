...
export const query = async (API_URL: string, suffix: string, method: Method = 'get', data: any = {}, controller?: AbortController, headers?: Record<string, string>) => {
  ...
  let request_data: any = method !== 'get' ? JSON.stringify(data) : null
