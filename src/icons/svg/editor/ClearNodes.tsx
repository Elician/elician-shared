export const ClearNodes = () => {
  return (
    <svg
      fill="currentColor" width="800px" height="800px" viewBox="0 0 1024 1024" className="icon"
      version="1.1" xmlns="http://www.w3.org/2000/svg" id="9723" xmlnsXlink="http://www.w3.org/1999/xlink"
    >
      <defs>
